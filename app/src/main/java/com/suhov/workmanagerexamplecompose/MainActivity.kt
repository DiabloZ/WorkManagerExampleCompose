...
import com.suhov.workmanagerexamplecompose.ui.theme.WorkManagerExampleComposeTheme
        ...
        setContent {
            WorkManagerExampleComposeTheme {
                Surface(
                    ...
                    mainInterfaces(workManager, downloadRequest, colorFilterRequest)
                }
            }
        }
    }
    ...
    fun mainInterfaces(
        ...
        Column(
            ...
            when(downloadInfo?.state){
                ...
                null -> Text(text = "Download failed")
            }
            Spacer(modifier = Modifier.height(8.dp))
